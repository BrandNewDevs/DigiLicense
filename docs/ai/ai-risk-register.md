...
| Bilingual factual drift | Medium | Locale-independent fact IDs, exact value/unit validation, and locale-specific fallbacks | Language coverage remains bounded | AI engineering: expand golden cases |
| Misleading official affiliation | High | Contextual affiliation checks, prototype labels, independent-product copy | Novel wording may evade rules | AI engineering: add red-team phrases |
